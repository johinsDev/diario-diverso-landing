...
export function CallToAction() {
  return <section className="relative bg-white pb-24 overflow-hidden full-width">
    <div className="bg-background w-screen top-1/2 bottom-0 absolute" />

    <div className="container mx-auto">
      <div className="relative bg-secondary rounded-lg px-16 py-12 text-left overflow-hidden">
        <div className="w-1/2">
          ...
          <Button className="mt-8 px-12 font-semibold" variant={"black"}>Get Started</Button>
        </div>
